<script lang="ts">
  ...
  import { isPubKeyMetadataLoading, type PubKeyString } from '$lib/dbs/types'
  import relays_manager from '$lib/stores/RelaysManager'
  import { getName } from './type'

  export let user: PubKeyString | undefined = undefined
