...
<div class="prose" class:text-sm={size === 'sm'}>
	<p>download binaries and add them to a directory from which they can be run globally:</p>
	<p>
		<a
	...
	<p>
		alternatively, if you have cargo installed run<code>cargo install ngit</code> or build from
		source using
		<a class="link-primary" href="https://codeberg.org/danconwaydev/ngit-cli" target="_blank"
			>this git clone url</a
		>.
	</p>
</div>
