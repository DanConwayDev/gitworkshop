...
let proposal_replies_unsubsriber: (() => void) | undefined = undefined
...
export const ensureProposalFull = async (
  ...
  if (proposal_replies_unsubsriber) proposal_replies_unsubsriber()
  ...
  proposal_replies_unsubsriber = memory_db.inserted.subscribe(
    (event: Event) => {
