      ...
      <TooltipTrigger asChild>
        ...
        >
          <Link to="/notifications" aria-label="Notifications">
            ...
            {unreadCount > 0 && (
              <span className="absolute -top-0.5 -right-0.5 flex h-4 min-w-[16px] items-center justify-center rounded-full bg-violet-500 px-1 text-[10px] font-medium text-white leading-none">
